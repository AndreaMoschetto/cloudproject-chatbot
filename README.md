...
2.  **Install Dependencies:**
    This project uses `conda`. All required libraries (like `fastapi`, `chainlit`, `langchain-chroma`, `pymupdf4llm`, etc.) should be installed in your environment.
...
You must run the ingestion script *first* to build the vector database.
...
This application runs as two separate services. You'll need two terminals.
